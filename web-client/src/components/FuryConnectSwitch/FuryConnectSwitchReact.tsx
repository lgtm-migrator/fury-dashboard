...
import { DynamicComponentWrapper } from "../../components/DynamicComponentWrapper/DynamicComponentWrapper";


export default function FuryConnectSwitchReact() {
  // INFO: Each state variable represents a remote component from a federated module
  const [furyConnectSwitch, setFuryConnectSwitch] = useState(undefined);
  ...
  return (
    <>
      ...
      <DynamicComponentWrapper componentConfig={furyConnectSwitch} />
